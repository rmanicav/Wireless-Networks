...
set opt(tr)		"vbf_atck_flood.tr"	;# trace file
set opt(datafile)	"vbf_atck_flood.data"
set opt(nam)            "vbf_atck_flood.nam"  ;# nam file
set opt(adhocRouting)   Vectorbasedforward
set opt(width)           500
set opt(interval)        0.1
...
$node_(9) set interval_ $opt(interval)
...
$node_(9) color "violet"
$node_(10) color "violet"
$node_(0) shape box
...
$ns_ at $opt(stop).004 "$a_(0) terminate"
...
$ns_ at $opt(stop).008 "Packet Send is  "
