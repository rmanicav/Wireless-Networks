...
set opt(z)              1500
set opt(seed)		11
set opt(stop)		1250	;# simulation time
set opt(prestop)        400 ;# time to prepare to stop
set opt(tr)		"vbf_atck_sinkhole_2.tr"	;# trace file
set opt(datafile)	"vbf_atck_sinkhole_2.data"
set opt(nam)            "vbf_atck_sinkhole_2.nam"  ;# nam file
