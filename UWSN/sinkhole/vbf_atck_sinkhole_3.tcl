...
set opt(tr)		"vbf_atck_sinkhole_3.tr"	;# trace file
set opt(datafile)	"vbf_atck_sinkhole_3.data"
set opt(nam)            "vbf_atck_sinkhole_3.nam"  ;# nam file
set opt(adhocRouting)   Vectorbasedforward
set opt(width)           200
set opt(interval)        10.0
set opt(range)           200   ;#range of each node in meters
...
$node_($total_number) set X_  100
$node_($total_number) set Y_  -130
$node_($total_number) set Z_  -130
$node_($total_number) set-cx  100
$node_($total_number) set-cy  -130
$node_($total_number) set-cz  -130
...
$node_(11) set sinkStatus_ 1
$god_ new_node $node_(11)
$node_(11) set X_  150
$node_(11) set Y_  -30
$node_(11) set Z_  -30
$node_(11) set passive 1


set rt [$node_(11) set ragent_]
$rt set control_packet_size  $opt(routing_control_packet_size)

set a_(11) [new Agent/UWSink]
$ns_ attach-agent $node_(11) $a_(11)
$a_(11) attach-vectorbasedforward $opt(width)
$a_(11) cmd set-range $opt(range) 
$a_(11) cmd set-target-x -20
$a_(11) cmd set-target-y -10
$a_(11) cmd set-target-z -10
$a_(11) cmd set-filename $opt(datafile)
$a_(11) cmd set-packetsize $opt(packet_size) ;# # of bytes

$ns_ initial_node_pos $node_(11) 30


set node_(12) [ $ns_  node 12]
$node_(12) set sinkStatus_ 12
$god_ new_node $node_(12)
$node_(12) set X_  75
$node_(12) set Y_  -60
$node_(12) set Z_  -60
$node_(12) set passive 1

set rt [$node_(12) set ragent_]
$rt set control_packet_size  $opt(routing_control_packet_size)
$node_(12) set max_speed $opt(maxspeed)
$node_(12) set min_speed $opt(minspeed)
$node_(12) set position_update_interval_ $opt(position_update_interval)
set a_(12) [new Agent/UWSink]
$ns_ attach-agent $node_(12) $a_(12)
$a_(12) attach-vectorbasedforward $opt(width)
$a_(12) cmd set-range $opt(range) 
$a_(12) cmd set-target-x  -20
$a_(12) cmd set-target-y  -10
$a_(12) cmd set-target-z  -10
$a_(12) cmd set-filename $opt(datafile)
$a_(12) cmd set-packetsize $opt(packet_size)
$ns_ initial_node_pos $node_(12) 30
...
#$ns_ at 0.0 "$a_(9) sink_hole"
$ns_ at 0.0 "[$node_(9) set ragent_] $opt(sinkhole)"
$ns_ at 0.0 "[$node_(11) set ragent_] $opt(sinkhole)"
$ns_ at $start_time "$a_(5) cbr-start"
